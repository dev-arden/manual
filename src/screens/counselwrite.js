  ...
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      <ScrollView style={{flex:2}}>
        ...
        />
        <Textlist 
          text="설명드린 6가지 사항에 대해 충분히 이해하셨다면 설명사항 확인란에 확인 일자,성명을 작성 하신 후 서명하시면 됩니다."
        />
        <Textlist 
          text="도장을 찍으셔도 됩니다."
        />
        <Textlist 
          text="작성된 사전연명의료의향서는 법적으로 본인 또는 향후 작성자가 말기 환자 또는 임종과정에 있는 환자가 되었을 때 담당의사에 의해 조회될 수 있습니다."
        />
        <Textlist 
          text="가족이 의향서 작성기록을 볼 수 있게 열람하는 것을 허락할지 여부를 결정할 수 있습니다."
        />
        <Textlist 
          text="가족에게 열람 허용, 열람 거부, 결정하기 어려운 경우 그 밖의 의견으로 체크할 수 있습니다."
        />
        <Textlist 
          text="작성을 원하시는지 최종적으로 확인하고, 마지막으로 작성일과 작성자란에 성명을 작성한 후 서명을 부탁드립니다."
        />
        <NavLink 
          text="추가 설명 확인하기"
          routeName="counselwrite12"
        />
      </ScrollView> 
      <Buttonlist
        title = "다음"
