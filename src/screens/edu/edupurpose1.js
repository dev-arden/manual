  ...
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      <ScrollView style={{flex:2}}>
        ...
        />
        <Textlist 
          text="모든 환자는 최선의 치료를 받으며, 자신이 앓고 있는 질병의 상태와 향후 본인에게 시행될 의료 행위에 대하여 충분히 이해하고 스스로 결정할 권리를 보장받아야 한다."
        />
        <Textlist 
          text="의료인은 환자에게 최선의 치료를 제공하고, 연명의료중단 등 결정에 관하여 정확하고 자세하게 설명하고, 그에 따른 환자의 결정을 존중해야 한다."
        />
      </ScrollView> 
      <ButtonFinish 
        routename="eduinfo"
