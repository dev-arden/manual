  ...
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      <ScrollView style={{flex:2}}>
        ...
        />
        <Textlist 
          text="일반적으로 기도 확보를 위해 튜브를 삽입하는 기관 내 삽관이 필요한데, 기도삽관이나 기관절개술의 시행과정에서 침습적인 행위로 인해 치아나 기도의 손상, 식도 천공, 피하기종 및 출혈 등이 발생할 수 있으며 기도삽관 및 절개로 인한 통증 등으로 진정제와 승압제 등의 약물을 지속적으로 사용하기도 한다."
        />
        <Exwithhead 
          title="주의"
