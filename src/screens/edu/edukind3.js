  ...
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      <ScrollView style={{flex:2}}>
        ...
        />
        <Textlist 
          text="출혈(도관 삽입부 출혈, 위궤양출혈, 뇌출혈), 응고장애, 도관을 삽입한 하지의 허혈, 공기색전증, 혈전색전증 등의 부작용이 발생할 수 있음. 심장과 폐의 기능이 나빠져서(작동이 안 되어) 몸 안의 피를 외부 기계와 연결하여 나쁜 것은 제거하고 산소는 보충하여 몸으로 다시 넣는 방법."
        />
        <Textlist 
          text="주의: 임종에 직면시 체외생명유지술을 하지 않겠다는 것임."
        />
        {/* <Exwithhead 
          title="주의"
