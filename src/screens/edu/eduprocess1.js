  ...
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      <ScrollView style={{flex:2}}>
        ...
        />
        <Textlist 
          text="19세 이상 성인은 등록기관의 상담자와 1:1 상담을 통해 연명의료결정제도와 사전연명의료의향서에 관한 충분한 설명과 정보를 제공받고 상담 후 별도의 비용 없이 사전연명의료의향서를 작성할 수 있다."
        />
        <Textlist 
          text="작성자는 사전연명의료의향서를 작성하였더라도, 마음이 바뀌면 언제든지 가까운 등록기관을 방문하여 작성된 의향서의 내용을 변경 또는 철회할 수 있다."
        />
        <Textlist 
