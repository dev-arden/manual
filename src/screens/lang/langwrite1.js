    ...
    <SafeAreaView style={{flex:1}}>
      ...
      <ScrollView style={{flex:2}}>
        ...
        <View style={styles.talkliststyle}>
          ...
          <Text style={styles.talktextstyle}>
          그리고 호스피스에 대하여 설명해 드렸는데, 호스피스 이용할 의향이 있으신가요?
          </Text> 
          <Text style={styles.talktextstyle}>
          ...
          <Text style={styles.talktextstyle}>
          향후 OOO님이 사전연명의료의향서를 직접 작성하셨다는 것을 구두로 남기시면 이후 작성에 대한 적법성에 문제 제기가 될 때 OOO님의 본인이 직접 스스로 결정에 의한 것임을 확인할 수 있습니다.
          </Text> 
          <Text style={styles.talktextstyle}>
          구두로 남기시겠습니까?
          </Text>
