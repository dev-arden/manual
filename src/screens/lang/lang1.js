  ...
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      <ScrollView style={{flex:2}}>
        <Exwithhead 
          title="정의"
          text="글을 읽지 못하거나 이해하지 못하는 사람을 말함"
        />
        <ExImage 
          title="문해 능력 수준"
          text="출처:국가평생교육진흥원(2018). 2017년 성인문해능력조사."
          imageSource={require('../../../assets/lang1.png')}
          imageStyle={{height:250,width:330,resizeMode:'contain'}}
        />
        <View style={styles.exliststyle}>
          ...
          - 2017년 국가평생교육진흥원 조사에 의하면 우리나라 18세 이상 성인 중 기초적인 일상문제 해결이 어려운 수준(수준 1)의 인구는 전체 성인 중 7.2%로 약 311만명으로 추정하며, 그중 대부분은 70세 이상 고령자이나 60대부터 비율이 급격히 증가(60대 14.2%, 70대 28.7%, 80세 이상 76.7%)하고 있다.
          </Text> 
          <Text style={styles.extextstyle}>
          - 서명 시 자신의 이름 또는 성을 직접 작성하는 경우가 많으며, 이름을 보여주면 그릴 수 있다.
          </Text>
          <Text style={styles.extextstyle}>
          - 대부분 비문해자임을 드러내지 않기 위해 글을 읽거나 작성해야 하는 경우 자리를 회피하는 경우가 많다.
          </Text>
        </View>
      </ScrollView> 
      <Buttonlist 
